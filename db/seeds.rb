...
Review.create(bird_id: birds[0].id, feeder_id: feeders[3].id, rating: 5, text: "Top notch, couldn't be better")
Review.create(bird_id: birds[1].id, feeder_id: feeders[3].id, rating: 5, text: "Tastiest I've ever had")
Review.create(bird_id: birds[2].id, feeder_id: feeders[3].id, rating: 4, text: "Really good, but not for me")
